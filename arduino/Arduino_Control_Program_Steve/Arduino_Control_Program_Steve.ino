...
const int LEFT_MOTOR_ADJ = -5;  //SMS was -6, testing -5
...
void turn(long numTurns,char turnDirection)
{
  ...
  long left_turn_adjust = 8;   //for variations in encoder readings   // 4 old
  ...
  switch (turnDirection) 
  {
    case 'L':
    {
      ...
      {
        count_L = Count_Encoder_Left - (TURN_TICK_COUNT + left_turn_adjust); //was -
